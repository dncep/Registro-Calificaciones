package ids323.estudiantes.componentes.menu;
...
public class CItemMenu extends JMenuItem {
    ...
    public CItemMenu(Icon icon) {
        super(icon);
    }

    public CItemMenu(String text) {
        super(text);
    }

    public CItemMenu(Action a) {
        super(a);
    }

    public CItemMenu(String text, Icon icon) {
        super(text, icon);
    }

    public CItemMenu(String text, int mnemonic) {
        super(text, mnemonic);
    }
